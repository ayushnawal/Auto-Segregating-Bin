...
def main(args):
    ...
    parser.add_argument('-s', '--search', default='cardboard', type=str, help='search term')
    parser.add_argument('-n', '--num_images', default=10, type=int, help='num images to save')
    parser.add_argument('-d', '--directory', default='/Users/ayush/Downloads/', type=str, help='save directory')
